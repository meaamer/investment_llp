...
<script type="text/javascript">
    ...
    var total_km = $('#total_km').val();	
		...
		$.ajax({
    		...
    		data:{booking_id:booking_id,opening_km:opening_km,closing_km:closing_km,extra_kilometer:extra_kilometer,other_charges:other_charges,da:da,advance_amount:advance_amount,
          reason:reason,total_km:total_km},
    		success: function(response){
    	 	 alertify.alert('Update');
      		//$('#kms_details').html(response);
