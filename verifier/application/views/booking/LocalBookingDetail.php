  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <td>
			...
			<td>
          		<input type="number" class="form-control col-lg-1" name="extra_hour" id="extra_hour"  value="<?= $details['extra_hour'];?>" />
			</td>
			<td>
 ...
 function UpdateLocal(id){
    ...
    var total_km = $('#total_km').val();	
		...
		$.ajax({
    		...
    		data:{opening_km:opening_km,closing_km:closing_km,extra_hour:extra_hour,other_charges:other_charges,reason:reason,advance_amount,advance_amount,total_km:total_km},
