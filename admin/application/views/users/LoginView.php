...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Admin Login | Investollp</title>
        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="" alt=""><h1>Investollp</h1><h5>Admin Panel</h5>
                    </div>
                </div>
                <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Login with Investollp</span></h6>
            </div>
                ...
                <div class="card-block">
                    <form class="form-horizontal form-simple" id="send_details">
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            ...
                            name="admin_login" placeholder="Your Username" required>
